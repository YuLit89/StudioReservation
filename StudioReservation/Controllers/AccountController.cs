    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (user != null)
            {
                ...
                {
                    ViewBag.errorMessage = "Please activate your account before logging in.";
                    return View("Error");
                }
            }
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                // Send an email with this link
                 ...
                 await UserManager.SendEmailAsync(user.Id, "Reset Password", "As per request, please clicks <a href=\"" + callbackUrl + "\">here</a> to reset your password.");
        ...
        public ActionResult ForgotPasswordConfirmation()
        {
            ...
            ViewBag.Message = "An email will be sent to you to reset your password";
            return View();
        }
